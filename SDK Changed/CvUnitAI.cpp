...
/************************************************************************************************/
		...
		{
			if (!plotHasSeaBridge || !plot()->isAdjacentToLand())
		    {
...
/************************************************************************************************/
        if (true) 
		{         // "Initialization of variables is skipped by case label" fix
			...
			if (pPlot->getArea() == getArea() || canMoveAllTerrain() || (plotHasSeaBridge && pPlot->isAdjacentToLand()))
			{
				return true;
			}
        }
